...
global.location = process.env.LOCATION || "Indonesia";
...
global.ownernumber = [process.env.OWNER_NUMBER || '6285763590930'];

global.ownername = process.env.OWNER_NAME || 'STEVEN';


//~~~~~~<Website and Social Links>~~~~~~~~~~\\
global.websitex = process.env.WEBSITE_URL || "https://youtube.com/";

global.wagc = process.env.WHATSAPP_CHANNEL || "https://whatsapp.com/channel/";
...
global.botscript = process.env.SCRIPT_LINK || 'https://github.com/salmanytofficial/';

global.packname = process.env.PACK_NAME || "XLICON";

global.author = process.env.AUTHOR_NAME || "MΛDΣ BY STEVEN";

global.creator = process.env.CREATOR_NUMBER || "6285763590930@s.whatsapp.net";


//~~~~~~~~~~~~~<Bot Settings>~~~~~~~~~~~~~~~\\
global.xprefix = process.env.PREFIX || '.';

global.premium = [process.env.PREMIUM_NUMBER || '6285763590930'];
...
global.antiforeignnumber = process.env.ANTIFOREIGN_COUNTRYCODE || '62';
